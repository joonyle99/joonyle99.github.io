...
위 코드처럼 Vertex에는 Position 좌표가 있거나, Normal Vector, Color, Texture 좌표 등과 같은 다른 속성도 가지고 있는 경우가 많다. Vertex Layout은 각 속성이 사용하는 데이터 유형, 각 속성의 크기, 메모리 내 속성의 순서 등 이러한 속성이 메모리에 위치하는 방식을 정의한다.
...
![image](https://postfiles.pstatic.net/MjAyMzEwMTJfMTM0/MDAxNjk3MDk3Mjc0NTAw.wdw7MRvurGd1F0YxX7lIOk2p7bCxD8MIFynt7XWhj3Ag.mwgsUKcm4mQsBi9Sr7_tPSb9HWHaWFKRSBAU18g8hzog.PNG.gongjunyeol/image.png?type=w773){: .align-center}
